...
if args.method == 'variational_IB': 
    args.logs_dir += args.u_func_name + '_' + str(round(args.hyperparameter,2)).replace('.', '-')  + "_repl_" + str(args.repl_n) + "_a_"+ str(args.a)+"_b_"+str(args.b) + "_compound_train_8_no_dim_encoder" + '/'
    args.figs_dir += args.u_func_name + '_' + str(round(args.hyperparameter,2)).replace('.', '-') + "_repl_" + str(args.repl_n) + "_a_"+ str(args.a)+"_b_"+str(args.b) + "_compound_train_8_no_dim_encoder" + '/'
    args.models_dir += args.u_func_name + '_' + str(round(args.hyperparameter,2)).replace('.', '-') + "_repl_" + str(args.repl_n) + "_a_"+ str(args.a)+"_b_"+str(args.b) + "_compound_train_8_no_dim_encoder" + '/'
else:
